        ...
        while($row=mysqli_fetch_assoc($result_query)){
          ...
          <div class='card'>
                      ...
                      <div class='card-body'>
                        ...
                        <p class='card-text'>Price: $product_price MAD</p>
                        <a href='index.php?add_to_cart=$product_id' class='btn' style='background-color:#f2a7b8; border:none; color:white;'>Add to cart</a>
                        <a href='product_details.php?product_id=$product_id' class='btn' style='background-color:#fff; border:1.5px solid #f2a7b8; color:#f2a7b8;'>View more</a>
                      </div>
            </div>
          </div>";
        }
    ...
    if(!isset($_GET['brand'])){
      ...
      <div class='card'>
                  ...
                  <div class='card-body'>
                    ...
                    <p class='card-text'>Price: $product_price MAD</p>
                    <a href='index.php?add_to_cart=$product_id' class='btn' style='background-color:#f2a7b8; border:none; color:white;'>Add to cart</a>
                    <a href='index.php' class='btn' style='background-color:#fff; border:1.5px solid #f2a7b8; color:#f2a7b8;'>Go home</a>
                  </div>
        </div>
      </div>
      <div class='col-md-8'>
                  <div class='row'>
                      <div class='col-md-12'>
                          <h4 class='text-center mb-5' style='color:#f2a7b8;'>Related products</h4>
                      </div>
                      <div class='col-md-6'>
