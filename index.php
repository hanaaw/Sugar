...
<body>
    ...
    <div class="container-fluid p-0">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <?php
                        if(isset($_SESSION['username'])){ //Connecté → "Mon Compte"

                            echo "<li class='nav-item'>
                            <a class='nav-link' href='./users_area/profile.php'>My Account</a>
                            </li>";
                        } else { //Non connecté → "S'inscrire"
                            echo "<li class='nav-item'>
                        ...
                        ?>
                        <li class="nav-item">
                            <a class="nav-link" href="cart.php"><i class="fa-solid fa-cart-shopping"></i><sup><?php cart_item(); //cart_item() affiche le nombre d'articles dans le panier 
                            ?></sup></a>                                                    
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="index.php">Total Price: <?php total_cart_price(); //total_cart_price() affiche le prix total du panier 
                            ?> MAD</a>
                        </li>
                    </ul>
        ...
        <div style="background-color:#fff;">
            ...
            <p class="text-center">Shop the Best Products Online</p>
        </div>
        ...
        <div class="row px-1">
            <div class="col-md-10">
                <div class="row">
                    <?php
                    // calling function
                    getproducts(); // Récupère et affiche tous les produits de la BDD en grille
                    get_unique_categories(); //Fonctions qui récupèrent les catégories et marques uniques
                    get_unique_brands(); 
                    ?>
                </div>
            </div>
            <div class="col-md-2 p-0" style="background-color:#fce4ec;">
                <!-- brands to be displayed -->
                <ul class="navbar-nav me-auto text-center">
                    <li class="nav-item" style="background-color:#f2a7b8;">
                        <a href="#" class="nav-link text-white"><h4>Delivery Brands</h4></a>
                    </li>
                    <?php getbrands(); //Affiche la liste des marques disponibles sous forme de liens
                     ?>
                </ul>
