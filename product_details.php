    ...
    <div class="container-fluid p-0">
        ...
        <div class="row px-1">
            <div class="col-md-10">
                <div class="row">
                    <?php
                    view_details(); //écupère probablement l'product_id depuis l'URL (?product_id=5)
                    //  et affiche toutes les infos de CE produit : images, description, prix, bouton "Ajouter au panier"
